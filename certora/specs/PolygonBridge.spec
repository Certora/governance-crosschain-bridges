...
methods {
	...
	function updateFxChild(address) external;
	function updateFxRootSender(address) external;
	function getFxRootSender() external returns(address);
	function getFxChild() external returns(address);
